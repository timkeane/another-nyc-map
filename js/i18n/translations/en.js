export const translation = {
  ...
  "search": "Search",
  "boro": "Borough",
  "input.file.shp": "Shapefile",
  "input.file.geo": "GeoJSON File",
  "input.file.csv": "CSV File of Addresses for Geocoding",
  "input.url.geo": "GeoJSON URL",
  ...
  "csv.sort": "Sort",
  "csv.status": "status",
  "csv.address": "Choose the Address column...",
  "csv.borough": "Choose the Borough column...",
  "csv.city": "Choose the City column...",
  "csv.zip": "Choose the ZIP Code column...",
  "csv.none": "[None]",
  "csv.add": "Add row",
